import { AfterCreate, BelongsTo, Column, DataType, Default, ForeignKey, IsUUID, Model, PrimaryKey } from "sequelize-typescript";
...
export class BaseModel extends Model{
    ...
    @AfterCreate
    static async createMetaData(baseModel: BaseModel): Promise<void> {
        try {
