...
export class InfoController extends GenericController<Infos, InfoDTO, InfoDTO>({
  ...
  async createInfoForCourseSpecialization(
    ...
    return this.infoService.createInfoForCourseSpecialization(
  ...
  async getInfoByCourseSpecializationId(
    ...
    return this.infoService.getInfoByCourseSpecializationId(
      courseSpecializationId,
    );
  }
