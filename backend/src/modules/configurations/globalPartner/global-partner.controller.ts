...
export class GlobalPartnerController extends GenericController<
  GlobalPartner,
  GlobalPartnerDTO,
  UpdateGlobalPartnerDTO
>({ createObjDTO: GlobalPartnerDTO, updateObjDTO: UpdateGlobalPartnerDTO }) {
  constructor(private readonly globalPartnerService: GlobalPartnerService) {
    super(globalPartnerService);
  }
  ...
  UpdateCoverImages(
    ...
    return this.globalPartnerService.UpdateImages(file, id);
  }
}
