...
import { DropZone, AutoComplete,Button,Label ,Input} from 'components/layout';
...
const BlogForm = ({initialValues,isUpdate,slug,categoryData}: Props) => {
    const router= useRouter()
  const { mutate, isLoading } = useCreateOrUpdate({
    url: isUpdate ? `/configurations/blog/${slug}` : "/configurations/blog",
