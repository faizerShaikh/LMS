  ...
  return (
    ...
    >
      <div className="desktop:flex desktop:flex-wrap laptop:flex laptop:flex-wrap justify-between items-center border-b-2  desktop:py-8 laptop:py-8 py-3">
        ...
        {formik.values.nationality === "Indian" && (
          <div className="desktop:!w-[48%] laptop:!w-[48%] w-full mb-3">
            <p className="m-0 ">
            ...
            <TextField
              ...
              helperText={
                formik.touched.governmentIDType &&
                formik.errors.governmentIDType
              }
            >
              <MenuItem value="" disabled>
                Select an option
      ...
      <div className="!w-full desktop:flex desktop:flex-wrap laptop:flex laptop:flex-wrap justify-between items-center  mb-4 py-8 border-b-2">
        <div className="desktop:!w-[48%] laptop:!w-[48%] w-full mb-4">
          <p className="m-0 ">
            Country <span className="text-red-700">*</span>{" "}
          </p>
          <div className="!w-full mt-1  !border-0">
            <CountrySelect
              onChange={(e: any) => {
                setCountryid(e.id);
...
//     url: "/configurations/application-form",
//     method: "put",
//   });
//   const [countryid, setCountryid] = useState(0);
//   const [stateid, setstateid] = useState(0);
//   let optionsGender = ["Male", "Female"];
//   let optionsNationality = ["Indian", "Other Country"];
//   let optionGovernmentIDType = ["Pan Card", "AdharCard", "VoterId Card"];
//   let courseSpecializationData: any = [];
//   let response = useGetAll({ key: "/configurations/course-specialization" });
//   courseSpecializationData = response?.data?.rows;
...
//         <Form>
//           <Grid container gap={2} className="flex mt-4">
//             <Grid xs={5.8}>
...
//                   Mobile Number <span className="text-red-700">*</span>{" "}
//                 </p>
//                 <div className="border bg-gray-100 py-2  px-4 h-[39px]  rounded-md border-gray-300">
//                   <PhoneNumberField
//                     id="mobileNumber"
...
//                 type="datetime-local"
//                 name="dateOfBirth"
//                 value={moment(values.dateOfBirth).format("YYYY-MM-DDTHH:mm")}
//               />
//             </Grid>
...
//             </Grid>
//             <Grid xs={5.8}>
//               <Label text="Government ID Type" required />
//               <AutoComplete
//                 name="governmentIDType"
//                 options={optionGovernmentIDType}
//               ></AutoComplete>
//             </Grid>
//           </Grid>
...
//               <Input name="howDoYouKnowAboutRiseBack" />
//             </Grid>
//           </Grid>
//           <Grid container gap={2} className="flex mt-4">
//             <Grid xs={5.8}>
//               <AutoComplete
//                 name="specialization"
//                 options={courseSpecializationData || []}
