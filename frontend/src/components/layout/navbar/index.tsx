...
export const Navbar = ({ values }: any) => {
  ...
  return (
    <header>
      <MobileNav />
      <>
        <nav className="bg-blue-900 h-12 hidden justify-between items-center px-16 laptop:flex ">
        ...
        <nav className="h-16 hidden justify-between items-center  px-16 laptop:flex  ">
          <div>
            <Link href={"/"}>
              <Image
                alt="img"
