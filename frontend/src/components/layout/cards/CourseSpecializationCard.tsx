...
export const CourseSpecializationCard = ({
  ...
  return (
    <section className="px-28">
      <div className="border w-[320px] rounded-2xl  shadow-lg">
        <div className="border-b-2 mb-3">
          <Image
            width={100}
            height={100}
            src={`${process.env.BASE_MEDIA_URL}${item.cover_image}`}
            alt=""
          ...
          <div className="flex items-center">
            <Image
              width={100}
              height={100}
              src="/img2/dy-patil.jpg"
              alt=""
              className="w-32 h-16 "
            />
            <h2 className="border-l-2 border-black px-2 font-bold text-lg">
              {`${process.env.BASE_MEDIA_URL}${item.university.university_image}`}
            </h2>
          </div>
        </div>
        <div>
